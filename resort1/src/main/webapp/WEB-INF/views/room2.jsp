...
<div style="width: 90%;">
	...
	<div class="info">
		<p>
			<b>2호실</b><br /> 최대 2인<br /> <br /> 신흥 게스트하우스 2호실 시설 입니다. ^^ <br />
			2호실은 바다를 향한 창문 1개 냉장고 1대 TV 1대 에어콘 1대 화장실 1개 그리고 싱글침대2개로 이루어진 방입니다. <br />
	...
	<div style="width: 1050px;">
		<table id='photo' cellpadding='0' cellspacing='0' width='100%'
			...
			<tr>
				<td><img
					src="${pageContext.request.contextPath}/resources/img/room2.jpg"
					alt="room2"></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				<td><img
					src="${pageContext.request.contextPath}/resources/img/room2-1.jpg"
					alt="room2-1"></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				<td><img
					src="${pageContext.request.contextPath}/resources/img/room2-2.jpg"
					alt="room2-2"></td>
			</tr>
		</table>
	</div>
